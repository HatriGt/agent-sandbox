/**
 * The MCP panel's pure half: wire-name parsing and result-shape analysis that turns one-line JSON
 * blobs into readable indented output with a shape-derived summary ("42 rows").
 */
import { test } from "node:test";
import assert from "node:assert/strict";
import { analyzeResult, mcpSummary, parseMcpName } from "../web/src/lib/mcp.ts";
