...
/**
 * Console actions — crisp rounded rects (see index.css "Operations Slate"), not pills. `secondary`
 * and `icon-sm` are kept because the registry's message-scroller asks for them by name.
 */
